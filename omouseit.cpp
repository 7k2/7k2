...
int Mouse::is_key(unsigned scanCode, unsigned short skeyState, unsigned short charValue, unsigned flags)
{
	...
	case 0x0d: priChar = capitalChar = 'ì'; shiftChar = '^'; break;
	...
	case DIK_LBRACKET: priChar = capitalChar = 'è'; shiftChar = 'é'; 
			ctrlAlt = '['; ctrlAltShift = '{'; break;
	case DIK_RBRACKET: priChar = capitalChar = '+'; shiftChar = '*';
			ctrlAlt = ']'; ctrlAltShift = '}'; break;
	...
	case 0x27: priChar = capitalChar = 'ò'; shiftChar = 'ç'; ctrlAlt = '@'; break;
	// case DIK_APOSTROPHE: priChar = capitalChar = '\''; shiftChar = '\"'; break;
	case 0x28: priChar = capitalChar = 'à'; shiftChar = '°'; ctrlAlt = '#'; break;
	// case DIK_GRAVE: priChar = capitalChar = '`'; shiftChar = '~'; break;
	case 0x29: priChar = capitalChar = '\\'; shiftChar = '|'; break;
	// case DIK_BACKSLASH: priChar = capitalChar = '\\'; shiftChar = '|'; break;
	case 0x2b: priChar = capitalChar = 'ù'; shiftChar = '§'; break;
