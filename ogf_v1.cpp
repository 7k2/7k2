...
void Version_1_Town::convert_to_version_2(Town *townPtr)
{
	...
	townPtr->last_attacked_date = last_attacked_date;
...
void Version_1_NationBase::convert_to_version_2(Nation *nationPtr)
{
	...
	nationPtr->enemy_frythan_killed = enemy_frythan_killed;
	nationPtr->own_frythan_killed = own_frythan_killed;
	...
	nationPtr->is_own()_destroyed = is_own()_destroyed;
}
...
void Version_1_Nation::convert_to_version_2(Nation *nationPtr)
{
	...
	nationPtr->pref_town_defense = pref_town_defense;
