...
//
void MouseNone::set_boundary(int x1, int y1, int x2, int y2, int boundType)
{
}
...
//          0 - if not
//
int MouseNone::release_click(int buttonId)
{
   return 0;
}
//--------- End of MouseNone::release_click --------------//
...
//--------- Begin of MouseNone::clear_event ----------//
//
void MouseNone::clear_event()
{
}
//--------- End of MouseNone::clear_event --------------//
