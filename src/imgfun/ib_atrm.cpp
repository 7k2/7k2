...
void IMGbltAreaTransRemapHMirror(short *imageBuf, int pitch, int desX, int desY, char *bitmapBuf,
	int srcX1, int srcY1, int srcX2, int srcY2, short *colorTable)
{
	...
	int esi = 4 + srcY1 * bitmapWidth + srcX1 + bitmapWidth - 1;;	// 4 bytes are header fields (width, height)
