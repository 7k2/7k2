...
void IMGbltAreaTransRemapDecompress(short *imageBuf, int pitch, int desX, int desY, char *bitmapBuf,
	int srcX1, int srcY1, int srcX2, int srcY2, short *colorTable)
{
	...
	SeekForward(&pixelsToSkip, &esi, bitmapBuf, srcY1*bitmapWidth + srcX1);
