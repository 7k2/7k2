...
;Filename    : IB_TK.ASM
;Description : Blt a bitmap to the display surface buffer with color key transparency handling with a blacken mask
...
;-------- BEGIN OF FUNCTION IMGbltWTransBlacken ----------
;
; Put an non-compressed bitmap on image buffer.
; It handles color key transparency. The color key code is 255.
;
; Syntax : IMGbltWTransBlacken( imageBuf, pitch, x, y, bitmapBuf )
;
...
;-------------------------------------------------
		...
		PUBLIC	IMGbltWTransBlacken
IMGbltWTransBlacken   	PROC	imageBuf, pitch, x, y, bitmapPtr
		LOCAL	bitmapWidth
		STARTPROC
...
@@end:		ENDPROC
IMGbltWTransBlacken	ENDP

;----------- END OF FUNCTION IMGbltWTransBlacken ----------
