...
;Filename    : IB_ATK.ASM
;Description : Blt a bitmap to the display surface buffer without color key transparency handling with a blacken mask
;TODO        : Add in the blacken mask part
...
;----------- BEGIN OF FUNCTION IMGbltWAreaTransBlacken ------------
;
...
;
; Syntax : IMGbltWAreaTransBlacken( imageBuf, pitch, desX, desY, bitmapBuf, srcX1, srcY1, srcX2, srcY2 )
;
...
;-------------------------------------------------
		...
		PUBLIC    IMGbltWAreaTransBlacken
IMGbltWAreaTransBlacken PROC   	  imageBuf, pitch, desX, desY, bitmapPtr, srcX1, srcY1, srcX2, srcY2
		LOCAL	  srcLineDiff
		STARTPROC
...
@@skipPoint:
		...
		ENDPROC
IMGbltWAreaTransBlacken ENDP

;----------- END OF FUNCTION IMGbltWAreaTransBlacken ----------
