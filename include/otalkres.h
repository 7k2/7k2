...
enum { MAX_TALK_CHOICE = 10 };		// maximum talk lines can be displayed in the area
...
public:
	...
	int  			ai_send_talk_msg(int toNationRecno, int fromNationRecno, int talkId, int talkPara1=0, int talkPara2=0, int forceSend=0, int talkPara3=0, int talkPara4=0);
